...
|---|---|---|---|
| `ANFORDERUNGEN.md` | vor der ersten Zeile Code | jede Anforderung mit stabiler Kennung, Status und Beleg im Repo | jeder Belegpfad muss existieren — außer die Zeile trägt `offen` |
...
**Regeln, Anforderungen, das erste Gate.** Anforderungen erfassen, jede mit Kennung. Die
