...
Die Ausschreibung nennt IDP/OCR als Must-have (M2) und eine IDP-Pipeline mit
...
keine echten Belege (`docs/DATENSCHUTZ.md`), und die Ausschreibung nennt
...
- Die zweite Sprache aus der Ausschreibung steht dort, wo sie hingehört —
...
- **N2 bleibt nicht belegbar.** Tesseract ist kein „gängiges IDP-Tool“ im
  Sinne der Ausschreibung. Die Nahtstelle ist da, der Beleg nicht.
