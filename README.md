...
Portfolio-Projekt für eine Ausschreibung (n8n-Workflows für Dokumentenprozesse
in Logistik und Zoll). Die Ausschreibung steht wörtlich in
...
| Tests | 125 in JavaScript (Prüfziffern gegen Referenzwerte, Grenzfälle je Regel, Konfidenzpfad), 165 in Python (Normalisierung, Klassifikation, Tabellen, CII gegen Schema, Anbieterleser, Pseudonymisierung und Klassifikationsfallback, Ende zu Ende auf den PDFs), 92 + 23 in TypeScript (Zustand, Dienst, Darstellung; axe, Tastatur, kein Rollbalken), 12 für den eigenen n8n-Node |
...
uv run pytest                                            # 165 Tests; OCR-Tests ohne Tesseract übersprungen
