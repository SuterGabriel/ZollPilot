...
| n8n | 5 Workflows als Export (Prüfung mit zwei Eingängen, Fehler, Wiederholung, Alarm, Nachforderungen); die Code-Nodes sind aus `src/` gebündelt (ADR-004); ein eigener Node in TypeScript mit Credential-Typ in [nodes/](nodes/n8n-nodes-zollpilot/) ruft die Extraktion, 12 Tests ohne n8n |
